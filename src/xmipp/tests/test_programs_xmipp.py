...
class AngularDistance(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "--ang1 input/discreteAssignment.xmd --ang2 input/aFewProjections.sel --oroot %o/angleComparison --sym c3 -v 2",
...
class AngularProjectLibrary(XmippProgramTest):
    ...
    def test_case2(self):
        self.runCase(
            "-i input/phantomBacteriorhodopsin.vol -o %o/output_projections.stk --sym c6 --sampling_rate 5 --compute_neighbors --experimental_images input/aFewProjections.sel  --angular_distance -1",
            outputs=["output_projections.doc", "output_projections.stk", "output_projections_sampling.xmd"])

    def test_case3(self):
        self.runCase(
            "-i input/phantomBacteriorhodopsin.vol -o %o/output_projections.stk --sym c6 --sampling_rate 5 --compute_neighbors --experimental_images input/aFewProjections.sel  --angular_distance 10",
            outputs=["output_projections.doc", "output_projections.stk", "output_projections_sampling.xmd"])

    def test_case4(self):
        self.runCase(
            "-i input/phantomBacteriorhodopsin.vol -o %o/output_projections.stk --sym c6 --sampling_rate 5 --compute_neighbors --experimental_images input/aFewProjections.sel  --angular_distance 10 --near_exp_data",
            outputs=["output_projections.doc", "output_projections.stk", "output_projections_sampling.xmd"])

    def test_case5(self):
        self.runCase(
            "-i input/phantomBacteriorhodopsin.vol -o %o/output_projections.stk --sym c6 --sampling_rate 5 --method real_space",
            outputs=["output_projections.doc", "output_projections.stk"])
...
class ClassifyCompareClasses(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "--i1 input/CL2DBacteriorhodopsin/level_00/class_classes.xmd --i2 input/CL2DBacteriorhodopsin/level_01/class_classes.xmd -o %o/classes_hierarchy.txt",
...
class CtfCorrectIdr(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "-i input/projectionsBacteriorhodopsinWithCTF.sel --vol input/phantomBacteriorhodopsin.vol -o %o/idr2.stk",
            outputs=["idr2.stk"])
...
class CtfEstimateFromMicrograph(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "--micrograph input/Protocol_Preprocess_Micrographs/Micrographs/01nov26b.001.001.001.002.mrc --oroot %o/micrograph --dont_estimate_ctf",
            outputs=["micrograph.psd"])

    def test_case2(self):
        self.setTimeOut(400)
        self.runCase(
            "--micrograph input/Protocol_Preprocess_Micrographs/Micrographs/01nov26b.001.001.001.002.mrc --oroot %o/micrograph --sampling_rate 1.4 --voltage 200 --spherical_aberration 2.5 --pieceDim 256 --downSamplingPerformed 2.5 --ctfmodelSize 256  --defocusU 14900 --defocusV 14900 --min_freq 0.01 --max_freq 0.3 --defocus_range 1000",
            postruns=[
                "xmipp_metadata_utilities -i %o/micrograph.ctfparam --operate keep_column 'ctfDefocusU ctfDefocusV' -o %o/Defocus.xmd",
...
class CtfEstimateFromPsd(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "--psd %o/down1_01nov26b.001.001.001.002_Periodogramavg2.psd --sampling_rate 1.4 --voltage 200 --spherical_aberration 2.5 --defocusU 15000 --defocus_range 200 --ctfmodelSize 170",
            preruns=["cp input/down1_01nov26b.001.001.001.002_Periodogramavg.psd %o",
                     " xmipp_transform_downsample -i %o/down1_01nov26b.001.001.001.002_Periodogramavg.psd -o %o/down1_01nov26b.001.001.001.002_Periodogramavg2.psd --step 3"],
            postruns=[
                "xmipp_metadata_utilities -i %o/down1_01nov26b.001.001.001.002_Periodogramavg2.ctfparam --operate keep_column 'ctfDefocusU ctfDefocusV' -o %o/Defocus.xmd",
                'xmipp_metadata_utilities -i %o/Defocus.xmd --operate  modify_values "ctfDefocusU = (round(abs(15132.6-ctfDefocusU)/15132.6)*100)" ',
                'xmipp_metadata_utilities -i %o/Defocus.xmd --operate  modify_values "ctfDefocusV = (round(abs(14800-ctfDefocusV)/14800)*100)" '],
            outputs=["Defocus.xmd"])
...
class CtfGroup(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "--ctfdat input/ctf_group/all_images_new.ctfdat -o %o/ctf2 --wiener --wc -1 --pad 2 --phase_flipped --error 0.5 --resol 5.6",
            outputs=["ctf2_ctf.xmp", "ctf2Info.xmd", "ctf2_wien.xmp"])

    def test_case2(self):
        self.runCase(
            "--ctfdat input/ctf_group/all_images_new.ctfdat -o %o/ctf2 --wiener --wc -1 --pad 2 --phase_flipped --split input/ctf_group/ctf_split.doc",
            outputs=["ctf2_ctf.xmp", "ctf2Info.xmd", "ctf2_wien.xmp"])
...
class CtfPhaseFlip(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "-i input/Protocol_Preprocess_Micrographs/Micrographs/01nov26b.001.001.001.002.mrc -o %o/micrographFlipped.mrc --ctf input/Protocol_Preprocess_Micrographs/Micrographs/01nov26b.001.001.001.002.mrc.ctfparam",
...
class ImageHeader(XmippProgramTest):
    ...
    def test_case2(self):
        self.runCase("-i %o/newHeaderStack.xmd --assign",
                     preruns=["cp input/smallStack.stk %o",
                              " xmipp_metadata_selfile_create -p %o/smallStack.stk -o %o/smallStack.xmd -s",
                              " xmipp_metadata_utilities -i %o/smallStack.xmd -o %o/newHeaderStack.xmd --fill shiftY constant 2"],
    ...
    def test_case3(self):
        self.runCase("-i %o/newHeader.xmd --assign",
                     preruns=[" xmipp_image_convert input/smallStack.stk --oroot %o/smallImages:spi -o %o/images.xmd",
                              " xmipp_metadata_utilities -i %o/images.xmd -o %o/newHeader.xmd --fill shiftY constant 2"],
    ...
    def test_case4(self):
        self.runCase("-i %o/smallStack.xmd --reset",
                     preruns=["cp input/smallStack.stk %o",
                              " xmipp_metadata_selfile_create -p %o/smallStack.stk -o %o/smallStack.xmd -s",
                              " xmipp_metadata_utilities -i %o/smallStack.xmd -o %o/newHeaderStack.xmd --fill shiftY constant 2",
                              " xmipp_image_header -i %o/newHeaderStack.xmd --assign",
                              "xmipp_image_header -i %o/smallStack.xmd --extract -o %o/preOutputHeader.xmd"],
                     postruns=["xmipp_image_header -i %o/smallStack.xmd --extract -o %o/outputHeader.xmd"],
                     outputs=["outputHeader.xmd"])
    ...
    def test_case5(self):
        self.runCase("-i %o/images.xmd --reset",
                     preruns=[" xmipp_image_convert input/smallStack.stk --oroot %o/smallImages:spi -o %o/images.xmd",
                              "xmipp_metadata_utilities -i %o/images.xmd -o %o/newHeader.xmd --fill shiftY constant 2",
                              "xmipp_image_header -i %o/newHeader.xmd --assign",
                              "xmipp_image_header %o/images.xmd --extract -o %o/preOutputHeader.xmd"],
                     postruns=["xmipp_image_header %o/images.xmd --extract -o %o/outputHeader.xmd"],
                     outputs=["outputHeader.xmd"])
...
class ImageOperate(XmippProgramTest):
    ...
    def test_case6(self):
        self.runCase(
            "-i input/projectionsBacteriorhodopsin.stk --minus input/projectionsBacteriorhodopsinWithCTF.stk -o %o/diff.stk",
            outputs=["diff.stk"])
...
class ImageResize(XmippProgramTest):
    ...
    def test_case4(self):
        self.runCase(
            "-i input/header.doc --fourier 32 --dont_apply_geo --oroot %o/halvedFourierDim:xmp -o %o/halvedFourierDim.xmd",
            outputs=["halvedFourierDim000001.xmp", "halvedFourierDim000002.xmp", "halvedFourierDim000003.xmp",
                     "halvedFourierDim000004.xmp"])
...
class ImageRotationalPcaMpi(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase("-i input/smallStack.stk --oroot %o/invariant",
                     postruns=[
                         'xmipp_metadata_utilities -i %o/invariant.xmd -o %o/rename.xmd    --operate rename_column "weight wRobust"  --mode overwrite',
                         'xmipp_metadata_utilities -i %o/rename.xmd    -o %o/merge.xmd     --set merge  %o/invariant.xmd image  --mode overwrite',
                         'xmipp_metadata_utilities -i %o/merge.xmd     -o %o/substract.xmd  --operate modify_values "weight=round(abs(weight-wRobust)*10)"  --mode overwrite',
                         'xmipp_metadata_utilities -i %o/substract.xmd -o %o/reference.xmd --operate drop_column "wRobust"  --mode overwrite'],
...
class AngularClassAverageMpi(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "-i input/angular_class_average/current_angles.doc --lib input/angular_class_average/gallery_Ref3D_003.doc -o %o//projmatch --wien input/angular_class_average/ctf_wien.stk --pad 2 --split",
...
class ClassifyCL2DMpi(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "-i input/projectionsBacteriorhodopsin.stk --nref 4 --oroot class --odir %o --iter 4 --classicalMultiref",
            outputs=["images.xmd", "level_00/class_classes.stk", "level_00/class_classes.xmd",
                     "level_01/class_classes.stk", "level_01/class_classes.xmd"])
...
class ClassifyCL2DCoreAnalysisMpi(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase("--dir %o/input/CL2DBacteriorhodopsin --root class --computeCore 3.000000 3.000000",
                     preruns=[
                         "mkdir %o/input ; cp -r input/CL2DBacteriorhodopsin %o/input ; rm -rf %o/input/CL2DBacteriorhodopsin/.svn ; cp input/projectionsBacteriorhodopsin.stk %o/input"],
...
class NmaAlignment(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "-i 2tbv_prj00001.xmp  --pdb 2tbv.pdb --modes modelist.xmd --sampling_rate 6.4 -o output.xmd --resume",
            preruns=["cp input/2tbv* %o ; cp input/modelist.xmd %o ; cp input/mode0.mod0028 %o"],
            postruns=["xmipp_metadata_utilities -i %o/output.xmd --operate keep_column 'cost' -o %o/cost.xmd",
                      'xmipp_metadata_utilities -i %o/cost.xmd --operate  modify_values "cost = round(cost*100.0)" '],
            outputs=["cost.xmd"],
            changeDir=True)
...
class PhantomSimulateMicroscope(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "-i input/projectionsBacteriorhodopsin.stk -o %o/smallStackPlusCtf.stk --ctf input/input.ctfparam --noNoise",
            outputs=["smallStackPlusCtf.stk"], errorthreshold=0.05)

    def test_case2(self):
        self.runCase(
            "-i input/projectionsBacteriorhodopsin.stk -o %o/smallStackPlusCtf.stk --ctf input/input.ctfparam --targetSNR 0.3",
...
class ReconstructArt(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase("-i input/projectionsBacteriorhodopsin.xmd -n 2 --thr 2 -o  %o/rec_art.vol --noisy_reconstruction",
                     postruns=["xmipp_image_statistics -i %o/rec_art.vol -o %o/stats.xmd",
                               "xmipp_metadata_utilities -i %o/stats.xmd --operate keep_column 'avg' -o %o/average.xmd",
                               'xmipp_metadata_utilities -i %o/average.xmd --operate  modify_values "avg = round(avg*10000.0)" '],
                     outputs=["average.xmd"])
    ...
    def test_case2(self):
        self.runCase("-i input/art.xmd -o  %o/rec_art.vol  --sym c1 --thr 1 --WLS  -l 0.2 -k 0.5 -n 1",
                     postruns=["xmipp_image_statistics -i %o/rec_art.vol -o %o/stats.xmd",
                               "xmipp_metadata_utilities -i %o/stats.xmd --operate keep_column 'avg' -o %o/average.xmd",
                               'xmipp_metadata_utilities -i %o/average.xmd --operate  modify_values "avg = round(avg*100000.0)" '],
                     outputs=["average.xmd"])
...
class ReconstructArtPseudo(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "-i input/projectionsBacteriorhodopsin.xmd --pseudo input/pseudoBacteriorhodopsin.pdb  -l 1 -n 5 -o  %o/rec_art_pseudo",
...
class ResolutionFsc(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "--ref input/phantomBacteriorhodopsin.vol -i input/phantomCandida.vol -s 5.6 --do_dpr --oroot %o/phantomBacteriorhodopsin ",
...
class ResolutionSsnr(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "-S input/Bacteriorhodopsin_rec_art.vol -N input/rec_art_noise.vol -selS input/rec_art_signal_proj.sel -selN input/rec_art_noise_proj.sel  -o %o/Bacteriorhodopsin_SSNR.txt --gen_VSSNR  --VSSNR %o/Bacteriorhodopsin_VSSNR.vol",
            postruns=["xmipp_image_statistics -i %o/Bacteriorhodopsin_VSSNR.vol -o %o/statistics.xmd",
                      'xmipp_metadata_utilities -i %o/statistics.xmd --operate drop_column "min max avg" ',
                      'xmipp_metadata_utilities -i %o/statistics.xmd --operate  modify_values "stddev = round(stddev*10.0)" '],
...
class TransformAdjustVolumeGreyLevels(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "-i input/phantomBacteriorhodopsin.vol -m input/projectionsBacteriorhodopsin.xmd -o %o/adjusted.vol",
...
class TransformGeometry(XmippProgramTest):
    ...
    def test_case7(self):
        self.runCase(
            "-i input/phantomBacteriorhodopsin.vol --rotate_volume euler 10 5 -10 -o %o/volume.vol --dont_wrap",
            outputs=["volume.vol"])
...
class VolumeAlign(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "--i1 input/phantomBacteriorhodopsin.vol --i2 input/phantomBacteriorhodopsinRotated30.vol --rot 0 120 5 --apply %o/i2aligned.vol",
            outputs=["i2aligned.vol"])

    def test_case2(self):
        self.runCase(
            "--i1 input/phantomBacteriorhodopsin.vol --i2 input/phantomBacteriorhodopsinRotated30.vol --rot 90 --local --apply %o/i2aligned.vol",
            outputs=["i2aligned.vol"])
...
class XrayProject(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "-i input/phantomCandida.vol -o %o/image.xmp --angles 0 90 90 -s 10 --psf input/xray_psf_with_volume.xmd",
            outputs=["image.xmp"])

    def test_case2(self):
        self.runCase(
            "-i input/phantomCandida.vol --oroot %o/projections --params input/tomoProjection.param -s 10 --psf input/xray_psf_with_volume.xmd",
...
class PhantomProject(XmippProgramTest):
    ...
    def test_case2(self):
        self.runCase(
            "-i input/phantomBacteriorhodopsin.vol     -o %o/projections --params input/clusterProjection_xmd.param",
            outputs=["projections.stk", "projections.xmd"])

    def test_case3(self):
        self.runCase(
            "-i input/phantomBacteriorhodopsin.vol     -o %o/projections --params input/uniformProjection_xmd.param",
            outputs=["projections.stk", "projections.xmd"])

    def test_case4(self):
        self.runCase(
            "-i input/phantomBacteriorhodopsin.vol     -o %o/projections --params input/uniformProjection_xmd.param --method shears",
            outputs=["projections.stk", "projections.xmd"])

    def test_case5(self):
        self.runCase(
            "-i input/phantomBacteriorhodopsin.vol     -o %o/projections --params input/uniformProjection_xmd.param --method fourier 2 0.5 bspline",
...
class MlAlign2d(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "-i input/images_some.stk --ref input/seeds2.stk --iter 2 --oroot %o/ml2d_ --fast --mirror --random_seed 100")

    def test_case2(self):
        self.runCase(
            "-i input/mlData/phantom_images.xmd --ref input/mlData/refs.xmd --iter 2 --oroot %o/ml2d_ --random_seed 100")

    def test_case3(self):
        self.runCase(
            "-i input/mlData/phantom_images.xmd --ref input/mlData/refs.xmd --iter 2 --oroot %o/ml2d_ --thr 2 --random_seed 100")
...
class MlfAlign2d(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase("-i input/mlData/phantom_images.xmd --ref input/mlData/refs.xmd --iter 2 --oroot %o/mlf2d_",
                     random=True,
...
class MlRefine3d(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "-i input/mlData/phantom_images.xmd --ref input/mlData/icoFiltered.vol  --recons fourier --ang 15 --iter 2 --oroot %o/ml3d_",
            random=True,
            outputs=["ml3d_ml2dimages.xmd", "ml3d_ml2dclasses.stk", "ml3d_ml2dclasses.xmd"])

    def test_case2(self):
        self.runCase(
            "-i input/mlData/phantom_images.xmd --ref input/mlData/icoFiltered.vol  --recons wlsART --ang 15 --iter 2 --oroot %o/ml3d_",
            random=True,
            outputs=["ml3d_ml2dimages.xmd", "ml3d_ml2dclasses.stk", "ml3d_ml2dclasses.xmd"])
...
class MlfRefine3d(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "-i input/mlData/phantom_images.xmd --ref input/mlData/icoFiltered.vol  --recons fourier --ang 15 --iter 2 --oroot %o/mlf3d_",
            random=True,
            outputs=["mlf3d_mlf2dimages.xmd", "mlf3d_mlf2dclasses.stk", "mlf3d_mlf2dclasses.xmd"])

    def test_case2(self):
        self.runCase(
            "-i input/mlData/phantom_images.xmd --ref input/mlData/icoFiltered.vol  --recons wlsART --ang 15 --iter 2 --oroot %o/mlf3d_",
            random=True,
            outputs=["mlf3d_mlf2dimages.xmd", "mlf3d_mlf2dclasses.stk", "mlf3d_mlf2dclasses.xmd"])
...
class MlTomoMpi(XmippProgramTest):
    ...
    def test_case1(self):
        self.runCase(
            "-i input/Ml_tomo/short.xmd --oroot %o/test1/iter22 --ref input/Ml_tomo/vir_norm.spi --missing input/Ml_tomo/wedgenew.doc --ang 5 --sym i3 --maxres .45 --dim 16 --iter 1 --maxCC",
            random=True,
