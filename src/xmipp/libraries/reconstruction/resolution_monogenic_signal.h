...
public:
    ...
    void runMonoRes(FileName &fnVol, FileName &fnVol2, double &minRes, double &maxRes,
			...
			int &nthres, MultidimArray<double> &FilteredResolution);
    ...
    void initMonoRes(MultidimArray<double> &inputVol, MultidimArray<double> *noiseVol, MultidimArray<int> &pMask);
