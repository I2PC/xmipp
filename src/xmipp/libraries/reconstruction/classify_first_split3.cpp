...
void ProgClassifyFirstSplit3::calculateProjectedIms (size_t id, double &corrI_P1, double &corrI_P2){
	...
	applyGeometry(xmippTransformation::LINEAR,projV,PV(),A,xmippTransformation::IS_INV,xmippTransformation::DONT_WRAP,0.);
...
void ProgClassifyFirstSplit3::run()
{
	...
	projectorV1 = new FourierProjector(2,0.5,xmippTransformation::BSPLINE3);
	projectorV2 = new FourierProjector(2,0.5,xmippTransformation::BSPLINE3);
