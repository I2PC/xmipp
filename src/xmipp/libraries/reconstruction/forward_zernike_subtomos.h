...
#ifndef _PROG_FORWARD_ZERNIKE_SUBTOMOS
#define _PROG_FORWARD_ZERNIKE_SUBTOMOS
...
class ProgForwardZernikeSubtomos: public XmippMetadataProgram, public Rerunable
{
public:
...
public:
    ...
    MultidimArray<int> mask3D, V_mask;
    // Volume size
    size_t Xdim;
    // Images Filename
    FileName fnImage;
    ...
    Matrix2D<double> A;
    // Original angles
    double old_rot, old_tilt, old_psi, deltaRot, deltaTilt, deltaPsi;
    // Original shift
	double old_shiftX, old_shiftY, old_shiftZ, deltaX, deltaY, deltaZ;
	// Original flip
	bool old_flip;
    // CTF Check
    bool hasCTF;
    // Original defocus
	double old_defocusU, old_defocusV, old_defocusAngle, deltaDefocusU, deltaDefocusV, deltaDefocusAngle;
    // Current defoci
