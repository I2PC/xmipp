...
// Main methods ===================================================================
void ProgStatisticalMap::preProcess() 
{
...
void ProgStatisticalMap::processParticle(const MDRow &rowprocess, int sizeImg) 
{	
...
// Core methods ===================================================================
void ProgStatisticalMap::frequencyCharacterization()
{
	// Calculate FT
...
void ProgStatisticalMap::noiseEstimation()
{
...
void ProgStatisticalMap::logLikelihood(double ll_I, double ll_IsubP, const FileName &fnImgOut)
{	
...
Image<double> ProgStatisticalMap::invertMask(const Image<double> &m) 
{
	PmaskI = m;
...
void ProgStatisticalMap::calculateBoundingBox(MultidimArray<double> PmaskRoiLabel, 
														std::vector<int> &minX, 
														std::vector<int> &minY, 
														std::vector<int> &maxX, 
														std::vector<int> &maxY, 
