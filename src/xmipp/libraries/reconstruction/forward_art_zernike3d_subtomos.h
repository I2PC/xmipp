...
#ifndef _PROG_FORWARD_ART_ZERNIKE3D_SUBTOMOS
#define _PROG_FORWARD_ART_ZERNIKE3D_SUBTOMOS
...
class ProgForwardArtZernike3DSubtomos: public XmippMetadataProgram
{
public:
...
public:
    ...
    MultidimArray<double> gaussian3d, gaussian_mw;
    // Fourier transformer 
...
public:
  ...
  private:
    ...
    void splattingAtPos(std::array<double, 3> r, double weight, 
