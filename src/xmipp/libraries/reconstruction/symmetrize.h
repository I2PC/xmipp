...
void symmetrizeVolume(const SymList &SL, const MultidimArray<double> &V_in,
                      MultidimArray<double> &V_out, int spline=xmippTransformation::BSPLINE3,
                      bool wrap=xmippTransformation::WRAP, bool do_outside_avg=false, bool sum=false, bool helical=false, bool dihedral=false,
...
void symmetrizeImage(int symorder, const MultidimArray<double> &I_in,
                      MultidimArray<double> &I_out, int spline=xmippTransformation::BSPLINE3,
                      bool wrap=xmippTransformation::WRAP, bool do_outside_avg=false, bool sum=false);
//@}
#endif
