 ...
 ***************************************************************************/
#ifndef PROG_SUPER_SL_HH
#define PROG_SUPER_SL_HH
...
/* The user interface program should make a call to the run routine.
  */
class ProgReconsSuperSlice: public XmippProgram
{
private:
