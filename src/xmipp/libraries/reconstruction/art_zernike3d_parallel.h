...
class ProgArtZernike3DParallel: public XmippMetadataProgram
{
public:
...
public:
    ...
    //                double rot, double tilt, double psi, int k);
    void deformVol(int k);

    void updateCTFImage(double defocusU, double defocusV, double angle);

    void parallelART(int direction);

    void forwardModel();

    void updateART(int k);
