...
def test():
  import os
  from ..utils.ioUtils import loadVol, saveVol

  dataPath="devel_code/tests/data/"
  fname= "devel_code/tests/data/EMD-7023_predLocscale.mrc"
  x= loadVol( fname )
  from devel_code.utils.dataUtils import resizeVol
  # x= resizeVol(x, (500,500,500))
  x_clean= removeSmallCCs(x)
  # saveVol(os.path.join( dataPath, emdb_id+"_pred_postpro.mrc"), x_clean, os.path.join( dataPath, emdb_id+"_pred.mrc"))
