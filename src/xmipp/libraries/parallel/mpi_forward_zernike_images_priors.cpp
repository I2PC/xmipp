...
#include <reconstruction/forward_zernike_images_priors.h>


class MpiProgForwardZernikeImagesPriors: public ProgForwardZernikeImagesPriors, public MpiMetadataProgram
{
...
public:
    ...
    void showProgress()
    {
        if (node->isMaster())
        {
            ...
            ProgForwardZernikeImagesPriors::showProgress();
        }
    }
    void preProcess()
    {
    ...
    void startProcessing()
    {
        ...
        {
        	verbose=1;
        	ProgForwardZernikeImagesPriors::startProcessing();
        }
        node->barrierWait();
    }
