...
#ifndef __MPI_RECONSTRUCT_SIGNIFICANT_H
#define __MPI_RECONSTRUCT_SIGNIFICANT_H

#include <reconstruction/reconstruct_significant.h>
#include "parallel/xmipp_mpi.h"

/**@defgroup MPIReconstructSignificant Reconstruct multiple volumes analyzing significant correlations (MPI)
