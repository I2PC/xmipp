...
void FourierProjector::produceSideInfo()
{
    ...
    if (BSplineDeg==xmippTransformation::BSPLINE3)
    {
        MultidimArray< double > VfourierRealAux, VfourierImagAux;
        Complex2RealImag(Vfourier, VfourierRealAux, VfourierImagAux);
        Vfourier.clear();
        produceSplineCoefficients(xmippTransformation::BSPLINE3,VfourierRealCoefs,VfourierRealAux);
        ...
        produceSplineCoefficients(xmippTransformation::BSPLINE3,VfourierImagCoefs,VfourierImagAux);
