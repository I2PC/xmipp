                              ...
                              const Matrix2D<double> &A)
{
    ...
    applyGeometry(xmippTransformation::LINEAR, tmp, tmp2, A, xmippTransformation::IS_NOT_INV, xmippTransformation::DONT_WRAP, outside);
                            ...
                            const Matrix2D<double> &A)
{
    ...
    // Instead of IS_INV for images use IS_NOT_INV for masks!
    applyGeometry(xmippTransformation::LINEAR, tmp, mask, A, xmippTransformation::IS_NOT_INV, xmippTransformation::DONT_WRAP, outside);
}
