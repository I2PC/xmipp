...
double Hlpf_fitness(double *p, void *prm)
{
    ...
    produceSplineCoefficients(xmippTransformation::BSPLINE3,splineCoeffsfhlpfFinelySampled,fhlpfFinelySampled);
...
void AtomInterpolator::addAtom(const std::string &atom, bool computeProjection)
{
    ...
    produceSplineCoefficients(xmippTransformation::BSPLINE3,splineCoeffs,profile);
