...
void ProgTransformGeometry::readParams()
{
    ...
    if (degree == "spline")
        splineDegree = xmippTransformation::BSPLINE3;
    else if (degree == "linear")
        splineDegree = xmippTransformation::LINEAR;
                                         ...
                                         MDRow &rowOut)
{
    ...
    if (applyTransform)
    {
        ...
        applyGeometry(splineDegree, imgOut(), img(), T, xmippTransformation::IS_NOT_INV, wrap, 0.);
