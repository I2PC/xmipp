...
void addLabels(PyObject * dict)
{
    ...
    ADD_CONST(MDL_CLASS_PROBABILITY);
    ...
    ADD_CONST(MDL_CLASS_INTERSECTION_SIZE_PVALUE);
    ADD_CONST(MDL_CLASS_INTERSECTION_RELATIVE_SIZE_PVALUE);
