...
void addLabels(PyObject * dict)
{
    ...
    ADD_CONST(MDL_TIME);
    ADD_CONST(MDL_TILT_ANALYSIS_MEAN);
    ADD_CONST(MDL_TILT_ANALYSIS_STD);
    ADD_CONST(MDL_TILT_ANALYSIS_MIN);
    ADD_CONST(MDL_TILT_ANALYSIS_MAX);
    ADD_CONST(MDL_TILT_ANALYSIS_PSDs);
