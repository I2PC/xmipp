...
PARAM_JOBS = 'jobs'
PARAM_BRANCH = 'branch'
PARAM_BRANCH_PLUGIN = 'branch-plugin'
...
PARAMS = {
	...
	PARAM_BRANCH: {
		SHORT_VERSION: "-b",
		LONG_VERSION: "--branch",
		DESCRIPTION: "Branch for the source binaries repositories."
	},
	PARAM_BRANCH_PLUGIN: {
		SHORT_VERSION: "-bP",
		LONG_VERSION: "--branchPlugin",
		DESCRIPTION: "Branch for the plugin repository."
	},
...
MODE_ARGS = {
	...
	MODE_ALL: [PARAM_JOBS, PARAM_BRANCH, PARAM_BRANCH_PLUGIN, PARAM_KEEP_OUTPUT],
	MODE_CONFIG_BUILD: [PARAM_KEEP_OUTPUT],
	MODE_CONFIG: [PARAM_OVERWRITE],
	MODE_GET_MODELS: [PARAM_MODELS_DIRECTORY],
	MODE_GET_SOURCES: [PARAM_BRANCH, PARAM_BRANCH_PLUGIN, PARAM_KEEP_OUTPUT],
	MODE_CLEAN_BIN: [],
	MODE_CLEAN_ALL: [],
...
MODE_EXAMPLES = {
	...
	MODE_ALL: [
		...
		f'./xmipp {PARAMS[PARAM_BRANCH][SHORT_VERSION]} binTagRelease {PARAMS[PARAM_BRANCH_PLUGIN][SHORT_VERSION]}  pluginTagRelease',
