...
__MATLAB = 'XMIPP_USE_MATLAB'
__LINK_SCIPION = 'XMIPP_LINK_TO_SCIPION'
...
CONFIG_VARIABLES = {
	TOGGLES: [
		__SEND_INSTALLATION_STATISTICS, __CUDA, __MPI, __MATLAB, __LINK_SCIPION
	],
	LOCATIONS: [
		CMAKE_HOME, GCC_HOME, GXX_HOME, __MPI_HOME, CUDA_COMPILER, __PYTHON_HOME,
