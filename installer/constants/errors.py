...
ERROR_CODE = {
	...
	CUFFTADVSOR_ERROR: ['Error compilling cuFFTAdvisor.', 'Please, read the compileLOG.txt file and documentation of the package.'],
	GOOGLETEST_ERROR: ['Error compilling googletest.', 'Please, read the compileLOG.txt file and read the documentation of the package.'],
	LIBSVM_ERROR: ['Error compilling libsvm.', 'Please, read the compileLOG.txt file and read the documentation of the package.'],
	LIBCIFPP_ERROR: ['Error compilling libcifpp.', 'Please, read the compileLOG.txt file and read the documentation of the package.'],
...
WARNING_CODE = {
	...
	CUDA_WARNING: ['CUDA not found.', 'Please review the NVCC flag on your xmipp.conf file.'],
