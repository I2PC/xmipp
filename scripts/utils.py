...
# def listDeprecatedFiles():
#     list_deprecated_files = ['xmipp_angular_distribution_show',
#                              'xmipp_apropos',
#                              'xmipp_mpi_ctf_correct_idr',
#                              'xmipp_ctf_correct_idr',
#                              'xmipp_ctf_create_ctfdat',
#                              'xmipp_ctf_show',
#                              'xmipp_idr_xray_tomo',
#                              'xmipp_image_common_lines',
#                              'xmipp_metadata_convert_to_spider',
#                              'xmipp_metadata_selfile_create',
#                              'xmipp_ml_tomo',
#                              'xmipp_mpi_ml_tomo',
#                              'xmipp_mrc_create_metadata',
#                              'xmipp_pdb_restore_with_dictionary',
#                              'xmipp_pdb_construct_dictionary',
#                              'xmipp_reconstruct_art_pseudo',
#                              'xmipp_resolution_ibw',
#                              'xmipp_resolution_ssnr',
#                              'xmipp_score_micrograph',
#                              'xmipp_transform_range_adjust',
#                              'xmipp_tomo_align_tilt_series',
#                              'xmipp_validation_tilt_pairs',
#                              'xmipp_volume_pca',
#                              'xmipp_volume_validate_pca',
#                              'xmipp_work_test',
#                              'xmipp_extract_subset',
#                              'xmipp_image_separate_objects',
#                              'xmipp_volume_enhance_contrast',
#                              'xmipp_volume_reslice',
#                              'xmipp_xray_import',
#                              'xmipp_xray_project',
#                              'xmipp_mpi_xray_project',
#                              'xmipp_xray_psf_create',
#                              'xmipp_tomo_remove_fluctuations',
#                              'xmipp_tomo_align_refinement',
#                              'xmipp_tomo_extract_subvolume',
#                              'xmipp_tomo_align_refinement',
#                              'xmipp_tomo_align_tilt_series',
#                              'xmipp_tomo_align_dual_tilt_series'
#                              ]
#     return list_deprecated_files
